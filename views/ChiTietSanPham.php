        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <?php if(isset($SanPham['gia_khuyen_mai']) &&$SanPham['gia_khuyen_mai'] != 0){?>
                    <h3 class="mb-4"><?= number_format($SanPham['gia_khuyen_mai'],0,',','.') ?> VND</h3><h3 class="text-muted ml-2"><del><?= number_format($SanPham['gia_san_pham'], 0, ',', '.'); ?> VND</del></h3>
               <?php }else{ ?>
              ...
              <?php } ?>
                ...
                <div class="d-flex mb-3">
                    <p class="text-dark font-weight-medium mb-0 mr-3">Lượt xem: <p class="mb-3"><?= $SanPham['luot_xem'] ?></p></p>
                    
                </div>
                <div class="d-flex mb-4">
                
                    <p class="text-dark font-weight-medium mb-0 mr-3">Trạng thái:  <p class="mb-3 <?= $SanPham['trang_thai'] == 1 ?'text-success' : 'text-danger' ?>"><?= $SanPham['trang_thai']== 1 ?'Còn hàng':'Hết hàng' ?></p></p>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="form-control bg-secondary text-center" value="1" readonly name="so_luong_mua">
                        <div class="input-group-btn">
                    ...
                    <a href=""><button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button></a>
                            ...
                            <div class="col-md-6">
                                ...
                                <form method="post" action="?act=add-binh-luan&id_san_pham=<?= $SanPham['id'] ?>">
                                    ...
                                    <div class="form-group mb-0">
                                        <?php if(isset($_SESSION['name'])){ echo '<input type="submit" value="Gửi" class="btn btn-primary px-3" name="addBinhLuan">' ;}else{
