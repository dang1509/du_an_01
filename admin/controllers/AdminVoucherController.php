...
class AdminVoucherController
{
    ...
    public function insertVoucher()
    {
        ...
        if (isset($_POST['btn_insert'])) {
            ...
            $GiaToiThieuDeGiam = $_POST['gia_toi_thieu_de_giam'];
            $GiaToiDaCoTheGiam = $_POST['gia_toi_da_co_the_giam'];
            ...
            if (empty($GiaToiThieuDeGiam)) {
                $error['gia_toi_thieu_de_giam'] = "Giảm tối thiểu không được để trống.";
            }
            if (empty($GiaToiDaCoTheGiam)) {
                $error['gia_toi_da_co_the_giam'] = "Giảm tối đa không được để trống.";
            }
            if (empty($batdau)) {
