    ...
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          ...
          <p class="text-success">Nhập ngày để xem thông kê</p>
          <div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header border-0">
              <h1 class="card-title">Doanh thu</h1>
            </div>
        ...
        <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-0">
                            <h1 class="card-title"> TOP 5 sản phẩm bán chạy nhất </h1>
                        </div>
                        <div class="card-body table-responsive p-0">
                            <table class="table table-striped table-valign-middle">
                                <thead>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-0">
                            <h1 class="card-title">Top 3 khách mua hàng nhiều nhất</h1>
                        </div>
                        <div class="card-body table-responsive p-0">
                            <table class="table table-striped table-valign-middle">
                                <thead>
