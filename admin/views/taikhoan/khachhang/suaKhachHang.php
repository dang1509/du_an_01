        ...
        <div class="row">
          ...
          <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Sửa tài khoản khách hàng: <?php echo $khachHang['ho_ten'] ?></h3>
              </div>
              ...
              <div class="form-group " >
                    ...
                    <select name="trang_thai" class='form-control' id="exampleFormControlSelect1" >
                      <option <?php $khachHang['trang_thai']==1?'selected':'' ?> value="1">Hoạt động</option>
                      <option <?php $khachHang['trang_thai']!==1?'selected':'' ?> value="2">Vô hiệu hóa</option>
                    </select>                      
              </div>
                </div>
